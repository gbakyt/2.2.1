...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      carService.add(new Car("Camry", "35"));
      carService.add(new Car("Camry", "75"));
      carService.add(new Car("Camry", "40"));
      carService.add(new Car("Camry", "60"));
      ...
      System.out.println("Looking for Camry 75");
      System.out.println(userService.findOwner("Camry", "75"));
